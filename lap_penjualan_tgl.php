...
$pdf->Image('../logo/toko olahraga.jpg',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'TOKO OLAHRAGA',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 0038XXXXXXX',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. TOKO OLAHRAGA',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'SPORT ACADEMY',0,'L');
