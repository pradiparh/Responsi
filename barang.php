...
<form action="cari_act.php" method="get">
	<div class="input-group col-md-5 col-md-offset-7">
		...
		<input type="text" class="form-control"aria-describedby="basic-addon1" name="cari">	
	</div>
</form>
<br/>
	...
	while($b=mysql_fetch_array($brg)){
		...
		<tr>
			...
			<td>
				...
				<a onclick="if(confirm('Hapus Data ini?')){ location.href='hapus.php?id=<?php echo $b['id']; ?>' }" class="btn btn-danger">Hapus</a>
			</td>
		</tr>		
		<?php 
	}
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="tmb_brg_act.php" method="post">
					...
					<div class="form-group">
						<label>Suplier</label>
						<input name="suplier" type="text" class="form-control">
					</div>
					<div class="form-group">
